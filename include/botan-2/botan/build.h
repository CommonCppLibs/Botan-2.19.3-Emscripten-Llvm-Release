...
* 'configure.py --cpu=llvm --os=emscripten --cc=clang --without-documentation --build-targets=static --prefix=Botan-2.19.3-Emscripten-Llvm-Release'
*
* Target
*  - Compiler: /home/x/emsdk/upstream/emscripten/em++  -std=c++11 -D_REENTRANT -O3 -emit-llvm -fno-use-cxa-atexit
*  - Arch: llvm
*  - OS: emscripten
*/
...
#define BOTAN_INSTALL_PREFIX R"(Botan-2.19.3-Emscripten-Llvm-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(Botan-2.19.3-Emscripten-Llvm-Release/lib)"
